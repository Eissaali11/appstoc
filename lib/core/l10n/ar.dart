...
const Map<String, String> ar = {
  ...
  'camera': 'الكاميرا',
  'gallery': 'المعرض',
  'profile_personal_section': 'المعلومات الشخصية',
  'profile_personal_hint': 'يرجى إدخال البيانات الشخصية الرسمية للموظف',
  'profile_full_name': 'الاسم الكامل',
  'profile_national_id': 'رقم الهوية / الإقامة',
  'profile_phone': 'رقم التواصل',
  'profile_birth_date': 'تاريخ الميلاد',
  'profile_id_expiry': 'تاريخ انتهاء الهوية',
  'profile_sponsor': 'اسم الكفيل',
  'profile_license_expiry': 'تاريخ انتهاء الرخصة',
  'profile_passport': 'رقم الجواز',
  'profile_passport_expiry': 'تاريخ انتهاء الجواز',
  'profile_nationality': 'الجنسية',
  'profile_absher': 'رقم خدمات أبشر',
  'profile_qualification': 'المؤهلات العلمية',
  'profile_job_section': 'المعلومات الوظيفية',
  'profile_job_hint': 'بيانات التعاقد والموقع الوظيفي والمرفقات',
  'profile_username': 'اسم المستخدم',
  'profile_job_title': 'المسمى الوظيفي',
  'profile_employee_number': 'الرقم الوظيفي',
  'profile_project': 'المشروع',
  'profile_job_offer': 'صورة العرض الوظيفي',
  'profile_promissory': 'صورة السند لأمر',
  'profile_other_files': 'صور أخرى',
  'profile_choose_file': 'اختر صورة أو PDF',
  'profile_custody_section': 'قسم العهد',
  'profile_custody_hint': 'تفاصيل الأصول والعهد المسلمة للموظف',
  'profile_car_custody': 'عهدة السيارة',
  'profile_car_plate': 'رقم اللوحة',
  'profile_car_type': 'نوع السيارة',
  'profile_car_model': 'الموديل',
  'profile_car_year': 'إصدار السيارة',
  'profile_car_handover': 'نموذج الاستلام والتسليم',
  'profile_phone_custody': 'عهدة الجوال',
  'profile_phone_type': 'نوع الجوال',
  'profile_phone_imei': 'السيريال (IMEI)',
  'profile_work_number': 'رقم العمل',
  'profile_sim_type': 'نوع الشريحة',
  'profile_save': 'حفظ الملف الشخصي',
  'profile_edit': 'تعديل الملف الشخصي',
  'profile_missing_section': 'بيانات غير مكتملة',
  'profile_missing_hint': 'الحقول التالية لم تُدخل بعد — يمكنك إضافتها عبر زر التعديل',
  'profile_empty_hint': 'لم يتم إدخال بيانات الملف الشخصي بعد. اضغط تعديل لإضافة معلوماتك.',
  'profile_photo_hint': 'لتغيير الصورة الشخصية: اضغط أيقونة الكاميرا على الأفاتار أعلاه.',
