  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (controller.error != null && controller.inventory.isEmpty && controller.pendingTransfers.isEmpty) {
        ...
        return RefreshIndicator(
          ...
          child: CustomScrollView(
            slivers: [
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ...controller.pendingTransfers.map((transfer) => 
                          _PendingTransferCard(
                            transfer: transfer,
                            itemType: controller.itemTypesMap[transfer.itemType],
              ...
              // Inventory List
              if (controller.inventory.isNotEmpty)
                SliverPadding(
